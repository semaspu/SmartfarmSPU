...
void loop() {
  OnLedSw(0);                   delay(1000);    //ON  LED  and Delay 1000 ms
  OffLedSw(0);                  delay(1000);    //OFF LED  and Delay 1000 ms 
  
  OnLedSw(1);                   delay(1000);    //ON  LED  and Delay 1000 ms
  OffLedSw(1);                  delay(1000);    //OFF LED  and Delay 1000 ms 
  
  OnLedSw(2);                   delay(1000);    //ON  LED  and Delay 1000 ms
  OffLedSw(2);                  delay(1000);    //OFF LED  and Delay 1000 ms 
  
  OnLedSw(3);                   delay(1000);    //ON  LED  and Delay 1000 ms
  OffLedSw(3);                  delay(1000);    //OFF LED  and Delay 1000 ms 
  
  OnLedStatus(wifi);            delay(1000);    //ON  LED  and Delay 1000 ms
  OffLedStatus(wifi);           delay(1000);    //OFF LED  and Delay 1000 ms 

  OnLedStatus(link);            delay(1000);    //ON  LED  and Delay 1000 ms
  OffLedStatus(link);           delay(1000);    //OFF LED  and Delay 1000 ms   

  OnLedStatus(weather);         delay(1000);    //ON  LED  and Delay 1000 ms
  OffLedStatus(weather);        delay(1000);    //OFF LED  and Delay 1000 ms 

  OnLedStatus(soil);             delay(1000);    //ON  LED  and Delay 1000 ms
  OffLedStatus(soil);           delay(1000);    //OFF LED  and Delay 1000 ms 
}
