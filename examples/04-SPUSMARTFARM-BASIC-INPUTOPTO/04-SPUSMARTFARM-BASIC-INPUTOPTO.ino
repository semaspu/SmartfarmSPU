...
void loop() {
  ...
  Serial.println(ReadOptoInput(0));
  if(ReadOptoInput(0)==HIGH)   OnLedSw(0);                    
  else    OffLedSw(0);   

  if(ReadOptoInput(1)==HIGH)   OnLedSw(1);                    
  else    OffLedSw(1);

  if(ReadOptoInput(2)==HIGH)   OnLedSw(2);                    
  else    OffLedSw(2);
  
  if(ReadOptoInput(3)==HIGH)   OnLedSw(3);                    
  else    OffLedSw(3);
  delay(500);
}
